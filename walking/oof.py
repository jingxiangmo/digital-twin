...
class RobotConfig:
    ...
    def __init__(self):
        self.joint_configs = [
            # Left arm
            {'name': "left_shoulder_yaw", 'servo_id': 11, 'offset_deg': 0.0},
            {'name': "left_shoulder_pitch", 'servo_id': 12, 'offset_deg': 0.0},
            {'name': "left_elbow_yaw", 'servo_id': 13, 'offset_deg': 0.0},  
            {'name': "left_gripper", 'servo_id': 14, 'offset_deg': 0.0},
            # Right arm
            {'name': "right_shoulder_yaw", 'servo_id': 21, 'offset_deg': 0.0},
            {'name': "right_shoulder_pitch", 'servo_id': 22, 'offset_deg': 0.0},
            {'name': "right_elbow_yaw", 'servo_id': 23, 'offset_deg': 0.0},
            {'name': "right_gripper", 'servo_id': 24, 'offset_deg': 0.0},
            # Left leg
            {'name': "left_hip_yaw", 'servo_id': 31, 'offset_deg': 0},
            {'name': "left_hip_roll", 'servo_id': 32, 'offset_deg': 0},
            {'name': "left_hip_pitch", 'servo_id': 33, 'offset_deg': 0},
            {'name': "left_knee", 'servo_id': 34, 'offset_deg': 0},
            {'name': "left_ankle", 'servo_id': 35, 'offset_deg': 0},
            # Right leg
            {'name': "right_hip_yaw", 'servo_id': 41, 'offset_deg': 0},
            {'name': "right_hip_roll", 'servo_id': 42, 'offset_deg': 0},
            {'name': "right_hip_pitch", 'servo_id': 43, 'offset_deg': 0},
            {'name': "right_knee", 'servo_id': 44, 'offset_deg': 0},
            {'name': "right_ankle", 'servo_id': 45, 'offset_deg': 0},
        ]
        self.torque_enable = True
        self.torque_value = 50.0
...
def main():
    robot = Robot()
    robot.initialize()
    robot.set_desired_positions({"right_hip_roll": 10.0})
